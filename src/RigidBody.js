...
RigidBody.prototype.calculateBoundaries = function() {
	this.boundaries = [
		new Vec(this.position.x + this.rect.x, this.position.y + this.rect.y),
		new Vec(this.position.x + this.rect.x + this.rect.width, this.position.y + this.rect.y),
		new Vec(this.position.x + this.rect.x + this.rect.width, this.position.y + this.rect.y + this.rect.height),
		new Vec(this.position.x + this.rect.x, this.position.y + this.rect.y + this.rect.height)
	];
